...
class SkiMatchingService {
  ...
  SkiMatch? _checkSkiMatch(
    ...
    try {
      ...
      const int POZIOM_TOLERANCJA_W_DOL = 2;
      if (poziom < poziomMin - POZIOM_TOLERANCJA_W_DOL) {
        return null;
      }
      ...
      if (waga >= ski.wagaMin && waga <= ski.wagaMax) {
        ...
        zielonePunkty++;
      } else if (waga > ski.wagaMax && waga <= ski.wagaMax + WAGA_TOLERANCJA) {
        dopasowanie['waga'] = MatchCriteria(
          status: 'orange',
      ...
      } else if (waga < ski.wagaMin && waga >= ski.wagaMin - WAGA_TOLERANCJA) {
        dopasowanie['waga'] = MatchCriteria(
          status: 'orange',
